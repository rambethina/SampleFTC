...
public class MecBot extends MecanumDrive {
    ...
    public static double WIDTH_LENGTH_AVERAGE = 15;         //Effective Track Width
    ...
    public MecBot(HardwareMap hardwareMap){
        super(kV, kA, kStatic, WIDTH_LENGTH_AVERAGE);

        constraints = new MecanumConstraints(
                new DriveConstraints(28.0, 30.0, 0.0, Math.PI, Math.PI, 0),
                WIDTH_LENGTH_AVERAGE);
