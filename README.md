...
mvn install:install-file -DrepositoryId=java.net -Durl=http://download.java.net/maven/2/ -Dfile=test.jar -DpomFile=test.pom -DgroupId=com.acmerobotics.dashboard -DartifactId=dashboard -Dversion=0.3.10 -Dpackaging=jar
mvn install:install-file -DgroupId=com.acmerobotics.dashboard -DartifactId=dashboard -Dversion=0.3.10 -Dpackaging=jar -Dfile=test.jar
```
